...
public class MailServer {
	...
	public static void sendStatusMail(String receiveMailAccount){
		try {
			sendMail(receiveMailAccount);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	}
    private static void sendMail(String receiveMailAccount) throws Exception {
